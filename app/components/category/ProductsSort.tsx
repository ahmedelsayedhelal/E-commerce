...
export function ProductsSort({ products, locale }: Props) {
  ...
  return (
    <>
      <div className="mb-6 flex items-center justify-start px-4 gap-2">
      ...
      <div className="grid gap-6 md:grid-cols-3 px-4 justify-center items-center">
        {sortedProducts.map((product) => (
          <div key={product.id} className="rounded-lg border p-4 flex flex-col items-center text-center">
